...
*This is the ninth essay in a series on building reliable agent systems. Previous essays covered [when agents fail](#), [the eval gap](#), [guardrails vs. safety](#), [who owns the agent's mistake](#), [drift is the default](#), [what an AI system should actually prove](#), [controls are not guardrails](#), and [anatomy of an evidence pack](#).*
